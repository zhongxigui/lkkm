...
config['appActivity']='com.lekelian.lkkm.view.splash.WelComeActivity'
config['noReset'] = True
...
bottom['请选择小区id']='com.lekelian.lkkm:id/iv_apply_key'
#bottom['登录按钮id'] ='com.lekelian.lkkm:id/iv_apply_key'
bottom['开门按钮id']='com.lekelian.lkkm:id/view_key_touch'
bottom['消息id']='com.lekelian.lkkm:id/img_home_notice'
bottom['我的客服id']='com.lekelian.lkkm:id/img_home_goserve'
bottom['选择开门方式确定按钮id']='com.lekelian.lkkm:id/btn_confirm'
bottom['关闭声音按钮id']='com.lekelian.lkkm:id/btn_close'
...
login['跳过id']='com.lekelian.lkkm:id/btn_skip'
...
global choosehous
choosehous={}
choosehous['点击搜索小区id']='com.lekelian.lkkm:id/ed_select_site2'
choosehous['返回id'] = 'com.lekelian.lkkm:id/img_title_left'
choosehous['查看更多id']='com.lekelian.lkkm:id/tv_add_myq'
choosehous['点击收起text']='点击收起'
choosehous['所在区域id']='com.lekelian.lkkm:id/tv_suozaiquyu'
choosehous['选择小区']='com.lekelian.lkkm:id/tv_neardy_name'
